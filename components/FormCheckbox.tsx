    ...
    <div>
      <div css={tw`flex gap-2`}>
        <button css={[
          ...
          error ? tw`border-red-200 ring-red-400 disabled:(border-red-100 ring-red-200)` : tw`border-gray-200 hover:(border-gray-300) active:(border-gray-500) ring-gray-400 disabled:(border-gray-100 ring-gray-200)`
        ]} onClick={onClick} disabled={disabled}>
          <span css={[
            tw`text-black transition duration-200`,
      ...
      <span css={[
        tw`text-red-600 text-xs font-light transform block transition duration-300`,
